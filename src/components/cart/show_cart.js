                                ...
                                return (
                                    <tr key={meal.id} className='mealAndProducts__meals--tableRow'>
                                        ...
                                        <td><label className='pointer'
                                                   onClick={() => this.props.removeMealFromCart(meal.id, new Date(), () => this.props.fetchCart(new Date()))}>Usuń</label>
                                        </td>
                                    </tr>
                                )
                            })}
                            ...
                            {_.map(this.props.cart.products, product => {
                                return (
                                    <tr key={product.id} className='mealAndProducts__products--tableRow'>
                                        ...
                                        <td><label className='pointer'
                                                   onClick={() => this.props.removeProductFromCart(product.id, new Date(), () => this.props.fetchCart(new Date()))}>Usuń</label>
                                        </td>
                                    </tr>
                                )
                            })}
